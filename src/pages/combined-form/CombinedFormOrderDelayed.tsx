...
import { DelayedTableTada, FormTableData, ServiceDetail } from './CombinedForm.deps';

function CombinedFormOrderDelayed() {
            ...
            fields: [
              ...
              },
              {
                ...
                props: {
                  ...
                  cols: DelayedTableTada.cols,
                  rows: DelayedTableTada.rows,
                },
              },
            ],
          },
...
export default CombinedFormOrderDelayed;
